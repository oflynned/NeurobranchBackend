...
//eligibilty form
    ...
    $("#e-add-more").click(function (ev) {
        ev.preventDefault();
        e_global_val++;
        $("#e-questionlist").append('<div class="e-dynamic"><hr/><div class="form-group">' +
            '<label for="e-q' + e_global_val + '_title">' + e_global_val + '. eligibilty Question </label>' +
            '<input type="text" class="form-control" name="e-q' + e_global_val + '_title" placeholder="Enter Title" required>' +
            '</div>' +
            ...
            '<option data-cat="">Scale</option></select>' +
            '</div><div class="form-group hide e-questions_answers"><label for="e-no_of_options">No Of Answers</label>' +
            '<select  class="form-control e-no_of_options" name="e-q' + e_global_val + '_no_of_options" >' +
            '<option value="0">Select no of Answers</option><option value="1">1</option><option value="2">2</option>' +
            '<option value="3">3</option><option value="4">4</option><option value="5">5</option></select></div>' +
            '<div class="form-group hide e-answers"><label for="e-no_of_options">Answers</label>' +
